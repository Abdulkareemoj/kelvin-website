          ...
          <div className="mx-auto max-w-lg">
            ...
            <dl className="mt-8 text-base text-gray-500">
              ...
              <div className="mt-6">
                ...
                <dd className="flex">
                  <AiFillPhone className="h-6 w-6 flex-shrink-0 text-gray-400" aria-hidden="true" />
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
            <form action="#" method="POST" className="grid grid-cols-1 gap-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex justify-center rounded-md border border-transparent bg-yellow-600 py-3 px-6 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Submit
                </button>
              </div>
